# 📧 Sistema de Notificaciones - B&B Car Wash

Guía completa de instalación y configuración del sistema de notificaciones automáticas.

## 🚀 Instalación Rápida

### 1. Instalar Dependencias
```bash
pip install celery redis django-celery-beat django-celery-results twilio
```
...
2. **Obtiene Account SID y Auth Token**
3. **Compra un número de teléfono** (+1 809/829/849)
4. **Añade a settings.py**:
```python
...
2. **Añade a settings.py** (ver `settings_final.py`)
...
client.messages.create(body='Test SMS', from_='+18091234567', to='+18091234567')
"
...
- **SMS a RD**: ~$0.05 USD por mensaje
- **100 SMS/mes**: ~$6 USD total
...
2. **Ejecuta pruebas**: `python test_notifications.py`
3. **Verifica configuración**: Compara con `settings_final.py`
4. **Reinicia servicios**: `./start_services.sh`

---

**🎉 ¡Felicidades! Tu sistema de notificaciones está listo para usar.**
