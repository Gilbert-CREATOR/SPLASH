"""
CONFIGURACIÓN DE EMAILS SOLAMENTE - B&B CAR WASH
Configuración simplificada sin SMS
"""

# ===================================
# EMAIL CONFIGURATION (SOLO EMAIL)
# ===================================
...
# ===================================
# CELERY CONFIGURATION (SOLO EMAILS)
# ===================================
...
# Colas para diferentes tipos de tareas (solo email)
CELERY_TASK_ROUTES = {
...
# ===================================
# CELERY BEAT SCHEDULE (SOLO EMAILS)
# ===================================
...
# ===================================
# NOTIFICATION SETTINGS (SOLO EMAIL)
# ===================================

NOTIFICATION_SETTINGS = {
    'EMAIL_ENABLED': True,
    'SMS_ENABLED': False,  # SMS deshabilitado
